...
.postnet_got7:
        in a,(slot5|1)          ;8843 Status bit 3 must be low
        and 0x08                ;8845
        jr nz,.postnet_timeout  ;8847 Fail if high
        ld a,0x18               ;8849 Now do command 0x18
        out (slot5|1),a         ;884b
        ld bc,0x2000            ;884d Reset our timeout
.postnet_wait2:
        in a,(slot5|1)          ;8850 And read status again
        and 0x80                ;8852 
        jr z,post_ram           ;8854 Success if bit 7 goes low
        dec bc                  ;8856
        ld a,b                  ;8857
        or c                    ;8858
